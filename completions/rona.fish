...
complete -c rona -n "__fish_rona_needs_command" -f -a "which-config" -d 'Show which configuration files would be used from a directory. Similar to \'git config --show-origin\' - displays all config sources and their priority'
complete -c rona -n "__fish_rona_needs_command" -f -a "find-config" -d 'Show which configuration files would be used from a directory. Similar to \'git config --show-origin\' - displays all config sources and their priority'
...
complete -c rona -n "__fish_rona_using_subcommand which-config" -s e -l effective -d 'Show the effective (merged) configuration values'
complete -c rona -n "__fish_rona_using_subcommand which-config" -s h -l help -d 'Print help'
complete -c rona -n "__fish_rona_using_subcommand find-config" -s e -l effective -d 'Show the effective (merged) configuration values'
complete -c rona -n "__fish_rona_using_subcommand find-config" -s h -l help -d 'Print help'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "add-with-exclude" -d 'Add all files to the `git add` command and exclude the patterns passed as positional arguments'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "commit" -d 'Directly commit the file with the text in `commit_message.md`'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "completion" -d 'Generate shell completions for your shell'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "config" -d 'Manage configuration files (create or edit local or global config)'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "generate" -d 'Directly generate the `commit_message.md` file'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "init" -d 'Initialize the rona configuration file'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "list-status" -d 'List files from git status (for shell completion on the -a)'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "push" -d 'Push to a git repository'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "set-editor" -d 'Set the editor to use for editing the commit message'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "sync" -d 'Sync current branch with main (or another branch) by pulling and merging/rebasing'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "which-config" -d 'Show which configuration files would be used from a directory. Similar to \'git config --show-origin\' - displays all config sources and their priority'
complete -c rona -n "__fish_rona_using_subcommand help; and not __fish_seen_subcommand_from add-with-exclude commit completion config generate init list-status push set-editor sync which-config help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
